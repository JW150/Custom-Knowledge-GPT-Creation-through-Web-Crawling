...
const messages = {
  url: "What is the 1st url of the websitea you want to crawl?",
  match: "What is the url pattern you want to match?",
  selector: "What is the css selecter you want to match?",
  maxPagesToCrawl: "How many pages would you like to crawl?",
